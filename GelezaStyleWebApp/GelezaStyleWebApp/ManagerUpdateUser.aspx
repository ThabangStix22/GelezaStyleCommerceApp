<%@ Page Title="Manager Update User" Async="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManagerUpdateUser.aspx.cs" Inherits="GelezaStyleWebApp.ManagerUpdateUser" %>
  ...
  <section class="inner-pages py-5">
         <div class="container py-xl-5 py-sm-3">
            ...
            <section class="typo-section py-4 border-top border-bottom">
               <h3 class="typo-main-heading mb-lg-4 mb-3 pr-3 pb-1">Update User</h3>
                <h4 class="typo-sub-heading mb-3" id="userNameTag" runat="server"></h4>
                <div>
                </div>
               ...
               <form runat="server" >
                   ...
                   <div id="goBackDiv" class="typo-section py-4 border-top border-bottom" visible="false" runat="server">
                      <a href="UpdateRemoveUser.aspx" class="btn btn-lg btn-primary" >Go back</a>
                     </div>
                

                   <div id="UpdateBox" visible="true" runat="server">
                 

                       <div class="form-group" >
                          <div class="form-group col-md-6">
                        <label for="inputUserType">User Type</label>
                        <select id="inputUserType" class="form-control" runat="server">
                       ...
                       <div class="form-group" >
                          <div class="form-group col-md-6">
                        <label for="inputActivate">User activation</label>
                        <select id="inputActivate" class="form-control" runat="server">
                           <option selected="">Choose...</option>
                 ...
                 <!-- <div class="form-row">
                  ...
                  <asp:button type="submit" class="btn btn-lg btn-primary" id="btnUpdate" runat="server"
                      OnClick="btn_Update" Text="Update User">
                  </asp:button>
