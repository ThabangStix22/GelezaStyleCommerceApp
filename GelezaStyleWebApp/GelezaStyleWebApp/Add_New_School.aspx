<%@ Page Title="Add New School" Async="True" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add_New_School.aspx.cs" Inherits="GelezaStyleWebApp.AddNewSchool" %>
    ...
    <section class="content">
      ...
      <div class="row" >
        <div class="col-12">
          ...
          <asp:button OnClick="btnCreateSchool" runat="server" type="submit" text="Create new School" class="btn btn-success float-right"></asp:button>
          </div> 
