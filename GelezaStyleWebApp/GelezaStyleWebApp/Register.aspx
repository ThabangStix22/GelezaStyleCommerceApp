<%@ Page Title="" Language="C#" Async="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="GelezaStyleWebApp.HomePage" %>
    ...
    <section class="inner-pages py-5">
         <div class="container py-xl-5 py-sm-3">
            ...
            <section class="typo-section py-4 border-top border-bottom">
               <h3 class="typo-main-heading mb-lg-4 mb-3 pr-3 pb-1">Registration Form</h3>
                <div>
                </div>
               ...
               <form runat="server" >
                   ...
                   <div id="RegistrationBox" visible="true" runat="server">

                   <div class="form-group">
                     <div class="form-group col-md-6">
                        <label for="lblName">First Name</label>
                         <input type="text" class="form-control" id="inputName" placeholder="e.g Thabiso" runat="server" required>
                     </div>
                 </div>
                   ...
                   <div class="form-group">
                     <div class="form-group col-md-6">
                       <label for="lblSurname">Surname</label>
                        <input type="text" class="form-control" id="inputSurname" placeholder="e.g Motlakase" runat="server" required>
                     </div>
                  </div>
                 
                   <div class="form-group">
                     <div class="form-group col-md-6">
                       <label for="lblAddress">Residential Address</label>
                       <input type="text" class="form-control" id="inputAddress" placeholder="e.g 123 Beyers Naude Rd" runat="server" required>
                     </div>
                  </div>
                   ...
                   <div class="form-group">
                     <div class="form-group col-md-6">
                      ...
                      <input  type="tel" class="form-control" id="inputPhoneNo" placeholder="e.g 0123456789" runat="server" required >
                     </div>
                  </div>
                   ...
                   <div class="form-group">
                     <div class="form-group col-md-6">
                       ...
                       <input type="email" class="form-control" id="inputEmail" placeholder="e.g matlao@domain.com" runat="server" required>
                     </div>
                  </div>
                   ...
                   <div class="form-group">
                     <div class="form-group col-md-6">
                       ...
                       <input type="password" class="form-control" id="inputPassword" placeholder="e.g Motlakase" runat="server" required>
                     </div>
                  </div>
                 ...
                 <!-- <div class="form-row">
                  ...
                  <asp:button type="submit" class="btn btn-primary" id="btnRegister" runat="server"
                      OnClick="btn_Register" Text="Register">
                  </asp:button>
